...
<div class="w3-top">
  <div class="w3-bar w3-black w3-card">
    ...
    <a href="{{url('about')}}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">ABOUT</a>
    <a href="{{url('skills')}}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">SKILLS</a>
    <a href="{{url('contact')}}" class="w3-bar-item w3-button w3-padding-large w3-hide-small">CONTACT</a>
